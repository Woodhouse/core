module.exports = function(api, users){
    ...
    api.listen('roles', 'roles request (.+?)', 'ignore', function(from, interface, message){
    ...
    api.listen('roles', 'roles list requests', 'trusted', function(from, interface, message, user){
