module.exports = function(api){
    api.listen('yesno','yes', function(from, interface, message){
    ...
    api.listen('yesno', 'no', function(from, interface, message){
        var yesNoQuestion = api.returnLastYesNoQuestion();
        if (yesNoQuestion) {
    ...
    api.listen('yesno', 'next question', function(from, interface, message){
        var yesNoQuestion = api.returnLastYesNoQuestion();
        if (yesNoQuestion) {
